...
/**
 * Реализация интерфейса {@linkplain ModelMultiOntology}.
 * @author Danilov E.Y.
 *
 */
public class ModelMultiOntologyImpl implements ModelMultiOntology
{
	private static final Logger log = LoggerFactory.getLogger(ModelMultiOntologyImpl.class);
	...
	private PresenterOntology presenter;
	/**
	 * {@linkplain ModelMultiOntologyImpl}
	 ...
	 */
	public ModelMultiOntologyImpl(OWLEditorKit protegeEditor, boolean convertToUPO, boolean convertToCognitiveFrame, boolean loadCF)
	{
	 ...
	 * @param loadCF - Загрузить CF.
	 */
	public ModelMultiOntologyImpl(String pathDirOntology, String fileOntopogy, boolean convertToUPO, boolean convertToCognitiveFrame, boolean loadCF)
	{
	...
	private void initEmptyOntology()
	{
		...
		InputStream ontUpoInputStream = ModelMultiOntologyImpl.class.getResourceAsStream("/" + DIR_EMPTY_ONTOLOGY + "/" + EMPTY_ONT_UPO);
		InputStream ontUpoCfInputStream = ModelMultiOntologyImpl.class.getResourceAsStream("/" + DIR_EMPTY_ONTOLOGY + "/" + EMPTY_ONT_UPO_CF);
		InputStream ontUpoSKOSInputStream = ModelMultiOntologyImpl.class.getResourceAsStream("/" + DIR_EMPTY_ONTOLOGY + "/" + EMPTY_SKOS);
	...
	@Override
	public void setPresenter(PresenterOntology presenter)
	{
		this.presenter = presenter;
	}
	@Override
	public PresenterOntology getPresenter()
	{
